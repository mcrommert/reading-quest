...
def post_daily_summary(reader: str, pts: float, pages: int, streak: int, day: date) -> bool:
...
def post_bingo_line(
    reader: str, line_label: str, square_labels: list, total_pts: float, day: date, bonus: int = 25
) -> bool:
